...
export const insertCaseSchema = createInsertSchema(cases).pick({
  ...
  treatment: z.enum(['repair', 'warranty', 'setup', 'other'] as const, {
    required_error: "Behandling er påkrævet",
    invalid_type_error: "Vælg en gyldig behandlingstype",
  }),
  priority: z.enum(['free_diagnosis', 'four_days', 'first_priority', 'asap'] as const, {
    required_error: "Prioritet er påkrævet",
    invalid_type_error: "Vælg en gyldig prioritet",
  }),
  deviceType: z.enum(['laptop', 'pc', 'printer', 'other'] as const, {
...
// Types related to Case with Customer
...
export type InternalCaseWithDetails = InternalCase & {
