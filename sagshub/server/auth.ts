console.log('LOADER: sagshub/server/auth.ts');
// =============================================================================
...
export async function comparePasswords(supplied: string, stored: string): Promise<boolean> {
  ...
  try {
    ...
    // DEBUG LOG
    console.log('DEBUG comparePasswords:', { supplied, stored, suppliedBuf: suppliedBuf.toString('hex'), storedBuf: storedBuf.toString('hex') });
